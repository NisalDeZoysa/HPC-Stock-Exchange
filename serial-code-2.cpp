...
int main()
{
    ...
    // Use same sellers as hybrid code with higher initial stock
    std::vector<Seller> sellers = {
        {"Alice", {100, 100, 100}, {6.0, 5.5, 7.0}},
        {"Bob", {100, 100, 100}, {5.5, 5.2, 6.5}},
        {"Charlie", {100, 100, 100}, {6.8, 5.0, 7.5}}};

    // Use same 23 buyers as hybrid code to match the workload
    ...
    int round = 0;
    const int MAX_ROUNDS = 50; // Same as hybrid code
    ...
    while (market_open && round < MAX_ROUNDS)
    {
        ...
        // Serial buyer-seller matching with improved logic (similar to hybrid)
        ...
        // Price drop for sellers (same as hybrid code)
        ...
        // Print current stocks after each round (like hybrid code)
        std::cout << "\nCurrent seller stocks:\n";
        for (auto &s : sellers)
        {
            std::cout << s.name << ": ";
        ...
        // Add computational delay to simulate more complex processing
        // This makes the serial code run longer for better comparison
        std::this_thread::sleep_for(std::chrono::milliseconds(100));

        // Additional computational work to increase runtime
